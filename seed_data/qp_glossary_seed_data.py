# Glossary of Terms
# TODO: if we add command for examples, break out the multi-line definitions
# into "definitions" and "examples" sections
# TODO: maybe add markdown formatting to the definitions
# TODO: add a "see also" section to the definitions? Or find another way to
# include this line from the notion doc:
...
SEED_DATA = {
    ...
    "CRC": """Cost of Retaining a Customer:
        ...
        In general, the cost of retaining a customer tends to be much lower than the cost of acquiring a new customer. In recurring revenue models, it tends to be just as, if not, more important to retain customers (Lean Revenue) as it is to find new ones (Expensive Revenue).
        """,
    ...
    "NPS": """Net Promoter Score - a metric that measures the loyalty of customers to a company. Typically measured with a response to a single survey question, the infamous "How likely are you to recommend XYZ to a friend or colleague?".
        Usually on a scale of 1-10. People fall into the following categories:
