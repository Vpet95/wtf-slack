        ...
        if client:
            ...
            completion = client.chat.completions.create(
                ...
                messages=[
                    {
                        "role": "system",
                        "content": "Please briefly explain the meaning of the following message from Slack in simple terms, so that someone without any background knowledge can understand it? Please clarify any technical terms, acronyms, or jargon used in the message.",
                    },
...
def processing_message(response_url: str):
    response = requests.post(
        response_url,
        json={
            "text": "Ok, I'm working on translating that message. This may take several seconds, sit tight!"
        },
    )
